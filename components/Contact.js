  ...
  return (
      <div id="contact" className="grid grid-rows-auto-1fr-auto items-center bg-gray-100 py-10">
          <div className="text-center text-black mx-10 mt-5 mb-20 row-start-1 row-end-2">
              ...
              <p className="text-xl mb-5">Have any questions or want to reach</p>
              <a href="mailto:mihiraraveeti@gmail.com" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="inline-flex items-center h-10 px-5 transition-colors duration-150 bg-black text-white rounded-full focus:shadow-outline hover:bg-gray-400">
